...
async def txt_handler(bot: Client, m: Message):
    ...
    credit = f"𝗦𝗣𝗜𝗗𝗬™"
    token = f"eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..Y2u4bKbJ6ToK7opuMYKF14zqiJiXJTuG7LwTY7QQOs3tE-y-HPZhJm11so4xN0-c"
    try:    
        with open(x, "r") as f:
            content = f.read()
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "edge.api.brightcove.com" in url:
                bcov = 'bcov_auth=eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..Y2u4bKbJ6ToK7opuMYKF14zqiJiXJTuG7LwTY7QQOs3tE-y-HPZhJm11so4xN0-c'
